...
require('lazy').setup({
  spec = {
    ...
    { import = 'plugins.coding.ts-autotag' },
    ...
    -- { import = 'plugins.ui.mini-animate' },
    { import = 'plugins.ui.neo-tree' },
    { import = 'plugins.ui.nui' },
    { import = 'plugins.ui.noice' },
    { import = 'plugins.ui.notify' },
    { import = 'plugins.ui.tree-sitter' },
    { import = 'plugins.ui.treesitter-context' },
    { import = 'plugins.ui.which-key' },
    { import = 'plugins.util.carbon' },
    { import = 'plugins.util.mini-hipatterns' },
    { import = 'plugins.util.no-neck-pain' },
    { import = 'plugins.util.outline' },
    { import = 'plugins.util.sleuth' },
    { import = 'plugins.util.spectre' },
    { import = 'plugins.util.supermaven' },
    -- { import = 'snippets.reactts' },
  },
  defaults = {},
  performance = {
    rtp = {
